// src/components/MouseTilt.jsx
// Magnetic Hover + Soft Lift Shadow Bloom wrapper
// - Lightweight, requestAnimationFrame driven
// - Mobile/touch disabled
// - Tailwind-friendly (use card-soft etc. inside)
