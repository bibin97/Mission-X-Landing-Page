    ...
    <section id="missions" className="section-padding bg-[var(--bg)] reveal-up">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          {/* Card 1 */}
          <MouseTilt>
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center reveal-card">
              
              {/* Image */}
              <div className="w-full h-[360px] flex justify-center items-center overflow-hidden rounded-xl bg-white/90 reveal-img">
                <img
                  src={M1}
                  alt="Mission 1"
              ...
              {/* Title */}
              <h3 className="mt-5 text-lg font-semibold text-[var(--text-dark)] reveal-typing">
                Structured like a game
              </h3>

              {/* Description */}
              <p className="mt-2 text-gray-600 text-sm leading-relaxed px-2 reveal-typing">
